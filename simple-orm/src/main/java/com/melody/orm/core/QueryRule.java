...
public final class QueryRule implements Serializable {
    ...
    private static final long serialVersionUID = -5640887590596213857L;
    ...
    protected class Rule implements Serializable{
        ...
        private static final long serialVersionUID = -4761922037077869423L;
        private int type;
        ...
        public Rule(int param, String property) {
            this.type = param;
            this.property_name = property;
        }

        public Rule(int param, String property, Object[] paramArray) {
            this.type = param;
            this.property_name = property;
